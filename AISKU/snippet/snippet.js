(function (win, doc, snipConfig) {
    ...
    var aisdk = win[aiName] || (function (aiConfig) {
        ...
        function _reportFailure(targetSrc) {
            ...
            var evts = [];
            evts.push(_createException(iKey, message, targetSrc));
            evts.push(_createInternal(iKey, message, targetSrc));
        ...
        function _createInternal(iKey, message, targetSrc) {
        ...
        function _createException(iKey, message, targetSrc) {
